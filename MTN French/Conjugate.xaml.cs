...
namespace MTN_French
{
    ...
    /// </summary>
    public sealed partial class Conjugate : Page
    {
        ...
        private void btnConjugate_KeyDown(object sender, KeyRoutedEventArgs e)
        {
           ...
           {
               e.Handled = true;
               pageConjugate.Focus(FocusState.Programmatic); // I honestly don't know what the hell this is
           }
        }
    }
}
